  ...
  useEffect(() => {
    const dummy2: RoomInfo = {
      ...
      roomUsers: [
        ...
        { userId: '3', nickname: '헤엥', outfit: 'formal', ready: false, word: null, score: 3, isAlive: false },
        { userId: '4', nickname: '웅냥냥', outfit: 'formal', ready: false, word: null, score: 1, isAlive: true },
        { userId: '5', nickname: '홀롤로', outfit: 'formal', ready: false, word: '바보', score: 4, isAlive: false },
